...
The notebook gives a general introduction to the metadata handling that is implemented by the [`metadata`]()-module in [`repro_eval`](https://github.com/irgroup/repro_eval) and provides the experiments of Section 6 in the resource paper.